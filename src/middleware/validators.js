...
const buscarEmpresaPorNITValidator = [
  param('nit')
    .notEmpty().withMessage('El NIT es requerido.')
    .isString().withMessage('El NIT debe ser una cadena de texto.')
    .trim(),
];

// Validaciones para crear una empresa
const crearEmpresaValidator = [
  body('Empresa').notEmpty().withMessage('El nombre de la empresa es requerido.'),
  body('NitCorrecto').notEmpty().withMessage('El NIT es requerido.'),
