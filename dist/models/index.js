...
db.Usuario.hasMany(db.Consulta, {
...
db.Usuario.hasMany(db.RegistroCargas, {
  foreignKey: "UsuarioID",
  onDelete: "CASCADE"
});
db.RegistroCargas.belongsTo(db.Usuario, {
  foreignKey: "UsuarioID"
});

// Verificación de conexión
sequelize.authenticate().then(() => console.log('✅ Conexión a la base de datos establecida')).catch(err => console.error('❌ Error de conexión a la base de datos:', err));
module.exports = db;